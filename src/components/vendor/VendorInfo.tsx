...
const CATEGORY_WARNINGS: Record<VendorCategory, string> = {
  ...
  MAKEUP: '담당자 지정 여부, 헤어피스 추가 여부, 혼주추가 여부에 따라 추가비용이 발생할 수 있습니다.',
    ...
    <section className="px-4 py-4">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[12px] text-gray-600">{fullAddress} {addressDetail}</p>

          {minPrice !== null && (
            <p className="mt-2 text-2xl font-bold text-primary-400 leading-9">
