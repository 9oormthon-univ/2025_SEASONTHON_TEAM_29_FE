...
export default function QueryInput({
  ...
  <div className="px-1">
    <div
      className="relative rounded-full bg-gray-100 pl-4 pr-10 py-3"
    ...
    >
      ...
      <div className="flex flex-nowrap items-center gap-2 overflow-x-auto scrollbar-hide">
        ...
        <input
          ...
          className="min-w-[120px] flex-1 bg-transparent text-[15px] outline-none placeholder:text-text-secondary"
        />
      </div>
